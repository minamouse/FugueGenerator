...
def generator_from_raw_dataset(batch_size, timesteps, voice_index,
    ...
    """
    print("generator from raw dataset")
...
def indexed_chorale_to_score(seq, pickled_dataset):
    ...
    :return:
    """
    print("indexed chorale to score")
...
if __name__ == '__main__':
    initialization();
    # make_dataset(None, BACH_DATASET, voice_ids=voice_ids_default, transpose=False)
    exit()
